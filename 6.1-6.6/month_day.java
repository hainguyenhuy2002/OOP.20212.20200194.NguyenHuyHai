...
public class month_day {
    public static void main(String[] args){
        ...
        if (month == 1 || month == 3 || month == 5 || month == 7 || month == 8 || month == 10 || month == 12){
			JOptionPane.showMessageDialog(null,"The month = " + month +" has 31 days in the year = " + year ,"result",JOptionPane.INFORMATION_MESSAGE);
		}
        if (month == 4 || month == 6 || month == 9 || month == 11){
			JOptionPane.showMessageDialog(null,"The month = " + month +" has 30 days in the year = " + year ,"result",JOptionPane.INFORMATION_MESSAGE);
		}
        if (month == 2)
        {
            if ((year%4!=0) ||((year % 100 == 0) && (year %400 != 0))) {
                JOptionPane.showMessageDialog(null,"The month = " + month +" has 28 days in the year = " + year ,"result",JOptionPane.INFORMATION_MESSAGE);
            }
            else{
                JOptionPane.showMessageDialog(null,"The month = " + month +" has 29 days in the year = " + year ,"result",JOptionPane.INFORMATION_MESSAGE);
        }
    }
}
}
